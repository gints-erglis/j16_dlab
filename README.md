...
- **`J16_DataLab-v0.2.0-setup.exe`** - the installable application (Windows x64).
...
- Full scan (bifragmented files support).
...
Please open an **Issue** with the version (e.g. `v0.2.0`), your Windows version,
